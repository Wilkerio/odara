...
export const fr: EthicsContent = {
  ...
  partI: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "sub", h: "Nos valeurs", v: "Ce ne sont pas des phrases accrochées au mur. Ce sont les critères que nous utilisons lorsque nous devons choisir." },
        {
          t: "list",
          v: [
            "Rigueur : nous structurons et étayons chaque opération avec une discipline d'underwriting, non avec de belles présentations. Ce qui ne passe pas notre propre analyse ne sort pas d'ici.",
            "Transparence : éclairer le capital est notre métier et aussi notre manière de travailler. Il n'y a pas de petites lignes, pas de coût caché, pas de promesse qui ne tienne dans un contrat.",
            "Indépendance : notre opinion technique n'est pas à vendre. Nous disons « non » à une bonne affaire lorsqu'elle porte un risque que nous ne pouvons pas soutenir avec honnêteté.",
            "Respect et fluidité : nous parlons la langue des deux mondes que nous connectons, sans sous-estimer aucun des deux. Expliquer le complexe avec clarté est une marque de respect, non une faveur.",
            "Responsabilité : chacune de nos décisions affecte un investisseur, une entreprise et, cumulées, la réputation de tout un marché. Nous décidons en le sachant.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        { t: "p", v: "Les valeurs ci-dessus deviennent conduite par des principes auxquels nous ne renonçons pas. Ils valent partout, en tout temps, et constituent la base sur laquelle la Partie II décrit le quotidien." },
        {
          t: "list",
          v: [
            ...
            "Le respect des personnes : nous traitons collègues, clients, partenaires et concurrents avec la même correction, indépendamment du rang, de l'origine ou de la taille du chèque.",
          ],
        },
      ],
    },
  ...
  partII: [
    {
      id: "kyc",
      num: "5",
      title: "Connaître qui se trouve de l'autre côté",
      blocks: [
        { t: "p", v: "Avant de structurer toute opération, nous devons savoir avec qui nous traitons et d'où vient l'argent. Ce n'est pas de la bureaucratie : c'est la différence entre une maison sérieuse et une blanchisserie. Chaque client, investisseur et contrepartie passe par une identification — le processus internationalement connu sous le nom de KYC (Know Your Customer, « connaissez votre client ») — et par une vérification de l'origine des fonds avant tout engagement, y compris l'identification des bénéficiaires effectifs (UBO — Ultimate Beneficial Owner)." },
        { t: "lead", v: "En pratique : aucune structuration ne débute, aucun term sheet n'est signé et aucun apport n'est accepté sans que le service responsable ait conclu la diligence. Si un client rechigne à indiquer qui sont les bénéficiaires effectifs ou d'où viennent les fonds, ce n'est pas un détail à contourner — c'est un signal à reporter." },
        { t: "p", v: "Certains signaux exigent une pause et une conversation avec la Conformité avant de poursuivre :" },
        {
          t: "list",
          v: [
            "des structures sociétaires en couches, sans explication économique qui tienne ;",
            "une hâte incompatible avec la taille de l'opération ;",
            "des fonds qui arrivent d'un tiers sans lien clair avec l'affaire ;",
            "l'usage de juridictions de secret sans finalité légitime évidente.",
          ],
        },
        { t: "p", v: "Aucun de ces signaux ne ferme la porte à lui seul. Tous obligent à poser la question avant de poursuivre. Dans le doute entre s'arrêter et continuer, on s'arrête." },
      ],
    },
    {
      id: "aml",
    ...
    },
    {
      ...
      blocks: [
        { t: "p", v: "Nous travaillons avec un capital qui traverse les frontières, et bien des frontières viennent avec des listes. L'OFAC (Office of Foreign Assets Control, des États-Unis), l'Union européenne, les Nations Unies et d'autres autorités tiennent des listes de personnes, d'entreprises et de territoires avec lesquels il est interdit de traiter. Violer une sanction ne dépend ni de l'intention ni de la connaissance : il suffit que l'opération ait lieu pour que la responsabilité existe." },
        { t: "lead", v: "En pratique : chaque contrepartie est contrôlée par rapport aux listes applicables avant d'entrer, et aucune opération n'avance en cas d'exposition à une personne ou à un territoire sanctionné. Face au moindre doute sur un pays, une banque intermédiaire ou un bénéficiaire, la règle est unique : ne présumez pas, consultez la Conformité, et ne déplacez rien avant d'avoir une réponse écrite." },
      ],
    },
    {
      id: "corrupcao",
    ...
    },
    {
      id: "presentes",
      num: "9",
      title: "Cadeaux et hospitalité",
      blocks: [
        { t: "p", v: "Une relation se construit par la compétence, non par les cadeaux. Un café, un déjeuner de travail, une invitation ponctuelle à un événement du secteur font partie de la vie professionnelle. Un cadeau coûteux, un voyage payé, une faveur personnelle, non." },
        { t: "quote", v: "La règle est honnête et tient en une phrase : rien qui embarrasse celui qui reçoit, rien qui crée un sentiment de dette, rien que vous auriez honte d'inscrire ouvertement au registre." },
        { t: "lead", v: "En pratique : les cadeaux et hospitalités dépassant EUR 150 (ou l'équivalent en monnaie locale) — limite de référence fixée et révisée par la Direction — doivent être refusés avec courtoisie, ou remis à la maison et déclarés à la Conformité. En aucun cas on ne donne ni n'accepte de l'argent, un équivalent d'argent ou toute gracieuseté liée à une décision d'affaires en cours — ni avant, ni pendant, ni « en remerciement » après. Les gracieusetés impliquant des agents publics, quel qu'en soit le montant, exigent l'approbation préalable de la Conformité." },
      ],
    },
    {
      id: "conflitos",
    ...
    },
    {
      ...
      blocks: [
        { t: "p", v: "La manière dont Odara parle du capital fait partie de ce qui la rend digne de confiance. Nous vendons de la structure, de la discipline et de l'accès — jamais de l'illusion. Il y a des choses qu'une maison sérieuse de crédit et de titrisation ne dit tout simplement pas, et les énumérer est plus honnête que de feindre que la tentation n'existe pas." },
        {
          t: "list",
          v: [
            "Nous ne promettons jamais de rendement : nous n'utilisons ni « garanti », ni « sans risque », ni « rentabilité assurée », ni rien qui suggère un résultat certain. Tout investissement comporte un risque ; notre métier est de le structurer et de l'expliquer avec honnêteté, non de le maquiller.",
            "Nous n'exagérons jamais : restent hors de notre vocabulaire « le meilleur du marché », « unique », « imbattable », « opportunité à ne pas manquer », « solution définitive ». Qui a besoin de crier qu'il est le meilleur admet qu'il ne peut pas le démontrer.",
            "Nous n'omettons jamais l'autre versant : toute pièce qui présente une opportunité présente aussi ses risques, coûts et conditions, au même endroit et avec la même mise en évidence. Les petites lignes qui contredisent le titre sont une forme de mensonge.",
            "Nous respectons le public de chaque message : certains produits et certaines informations sont réservés aux investisseurs qualifiés ou professionnels, selon la règle de chaque place — y compris les régimes d'offre exemptée applicables au Luxembourg et à Dubaï. On n'offre pas à un public ce que la loi réserve à un autre, et l'on ne transforme pas un support institutionnel en offre publique déguisée.",
          ],
        },
        { t: "lead", v: "En pratique : toute pièce externe qui parle d'opérations, de rendements, de produits ou de performance — présentation, site, publication, proposition — passe par une approbation avant diffusion. Entre une phrase plus vendeuse et une phrase plus précise, c'est la précise qui reste. Toujours." },
      ],
    },
    {
      id: "redes-sociais",
    ...
    },
    {
      ...
      blocks: [
        { t: "p", v: "Nous manipulons des données personnelles et financières de personnes qui nous les ont confiées. Bien les traiter est une obligation légale — la LGPD (Lei Geral de Proteção de Dados, Lei nº 13.709/2018) au Brésil, le GDPR (General Data Protection Regulation, Règlement (UE) 2016/679) en Europe et les régimes de protection des données applicables à Dubaï — et c'est de la décence avant d'être la loi." },
        { t: "lead", v: "En pratique : n'accédez qu'aux données nécessaires à votre travail, utilisez-les uniquement pour la finalité correcte et conservez-les seulement là où la maison le détermine. Une donnée personnelle ne se partage pas par commodité, ne va pas dans un outil non homologué — y compris les outils d'intelligence artificielle non approuvés par la maison — et ne reste pas en copie privée « par précaution ». Tout soupçon de fuite ou d'accès indu se signale sur-le-champ : le retard aggrave toujours." },
      ],
    },
    {
      id: "respeito",
    ...
    },
    {
      id: "duvida",
      num: "16",
      title: "Un doute sur la décision à prendre ?",
      blocks: [
        { t: "p", v: "Face à un dilemme que ce Code ne résout pas d'emblée, répondez avec honnêteté aux questions ci-dessous. Si vous répondez « oui » à celles du premier bloc et « non » à celles du second, vous êtes probablement sur la bonne voie. Toute autre combinaison exige une pause — et une conversation avec la Ligne Éthique avant d'agir." },
        { t: "sub", h: "Bloc 1 — la bonne voie répond « oui »", v: "" },
        {
          t: "list",
          v: [
            "Cette décision est-elle conforme à la loi applicable, à ce Code et aux politiques de la maison ?",
            "Soutient-elle la même histoire pour l'investisseur, pour l'emprunteur et pour le régulateur ?",
            "Serais-je à l'aise si cette décision devenait publique — dans la presse, pour ma famille, pour le marché ?",
            "En consultant mon responsable ou la Conformité, est-ce que je révèle tous les faits, et non seulement les plus commodes ?",
          ],
        },
        { t: "sub", h: "Bloc 2 — la mauvaise voie répond « oui »", v: "" },
        {
          t: "list",
          v: [
            "Est-ce que je décide sur la base du « ça a toujours été ainsi » ou de ce que « tout le monde fait », sans vérifier la règle ?",
            "Cette décision sert-elle, au fond, un intérêt personnel ou celui d'un proche ?",
            "Serais-je gêné d'expliquer cette décision, à voix haute, au comité d'éthique et au client en même temps ?",
            "Si je me tais, quelqu'un qui a commis un écart sera-t-il protégé — ou la maison sera-t-elle exposée ?",
          ],
        },
      ],
    },
    ...
    },
    {
      id: "descumprimento",
      num: "18",
      title: "Lorsque le Code n'est pas respecté",
      blocks: [
        { t: "p", v: "Enfreindre ce Code a des conséquences, proportionnées à la gravité et aux circonstances : de l'orientation et de l'avertissement jusqu'au licenciement et, lorsque la loi est violée, au renvoi devant les autorités compétentes. Cela vaut pour tous, du stagiaire à l'associé — et plus la position est élevée, plus grande est la responsabilité de donner l'exemple." },
        { t: "p", v: "Ce document ne remplace ni la loi, ni les contrats, ni les politiques internes spécifiques de la maison ; il les complète tous. En cas de conflit apparent entre une règle et une autre, consultez la Conformité avant d'agir." },
      ],
    },
    {
      id: "governanca",
      num: "19",
      title: "Gouvernance de ce Code",
      blocks: [
        {
          t: "list",
          v: [
