      ...
      <div className="space-y-3">
        <div>
          <span className="block font-['Cormorant_Garamond',serif] text-[1.15rem] font-light" style={{ color: "hsl(36,18%,96%)" }}>
            Alameda Vicente Pinzon, 54 - 3º andar, Vila Olímpia
          </span>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div className="max-w-[1280px] mx-auto px-6 md:px-16">
          <div className="py-14 md:py-16">
            ...
            >
              <iframe src="https://www.google.com/maps?q=Alameda+Vicente+Pinzon%2C+54+-+Vila+Ol%C3%ADmpia%2C+S%C3%A3o+Paulo+-+SP%2C+04547-130&output=embed" width="100%" height="100%" style={{ border: 0, filter: "invert(0.92) hue-rotate(180deg) brightness(0.75) contrast(1.2) saturate(0.3)" }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Odara Capital Partners — São Paulo" className="transition-all duration-700 group-hover:scale-[1.02]" />
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=Alameda+Vicente+Pinzon%2C+54+-+Vila+Ol%C3%ADmpia%2C+S%C3%A3o+Paulo+-+SP" target="_blank" rel="noopener noreferrer" className="absolute bottom-4 right-4 z-10 flex items-center gap-2 px-5 py-2.5 font-['DM_Sans',sans-serif] text-[0.65rem] tracking-[0.2em] uppercase no-underline transition-all hover:gap-3 rounded-sm" style={{ background: "hsl(232,25%,56%)", color: "hsl(36,18%,96%)", backdropFilter: "blur(10px)" }}>
                Get Directions
                <ArrowRight size={12} />
              </a>
            </motion.div>
