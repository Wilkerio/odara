    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Odara Capital Partners SPV — Registered office: 2 Parc d'Activités Capellen, 8308 Capellen, Luxembourg. Brazil office: Alameda Vicente Pinzon, 54, 3º andar, São Paulo, SP.",
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Odara Capital Partners SPV — Sede: 2 Parc d'Activités Capellen, 8308 Capellen, Luxemburgo. Escritório no Brasil: Alameda Vicente Pinzon, 54, 3º andar, São Paulo, SP.",
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Odara Capital Partners SPV — Domicilio social: 2 Parc d'Activités Capellen, 8308 Capellen, Luxemburgo. Oficina en Brasil: Alameda Vicente Pinzon, 54, 3º andar, São Paulo, SP.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        h: "1. Introduction",
        paragraphs: [
          'Odara Capital Partners SPV (« Odara », « nous », « notre ») est une société de titrisation constituée conformément aux lois du Grand-Duché de Luxembourg, dont le siège social est situé au 2 Parc d\'Activités Capellen, 8308 Capellen, Luxembourg, et disposant d\'un bureau Alameda Vicente Pinzon, 54, 3º andar, São Paulo, Brésil. Odara s\'engage à protéger les données personnelles des contreparties professionnelles, partenaires institutionnels et visiteurs du site web avec lesquels elle interagit.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Odara Capital Partners SPV — Siège social : 2 Parc d'Activités Capellen, 8308 Capellen, Luxembourg. Bureau au Brésil : Alameda Vicente Pinzon, 54, 3º andar, São Paulo, SP.",
        ],
      },
    ],
  },
